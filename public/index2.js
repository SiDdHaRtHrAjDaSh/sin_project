...
function suggestions() {
    $.ajax({
        url: "http://localhost:9696/suggestion2 ",
        success: function (result) {
            ...
            function plotLoop() {
                ...
                if (i == 10)
                    $('#graph11').append('<div class="gs">Iteration 10</div>');  
                if (i == 11)
                    $('#graph12').append('<div class="gs">Iteration 11</div>');  
                if (i == 12)
                    $('#graph13').append('<div class="gs">Iteration 12</div>');  
                if (i == 13)
                    $('#graph14').append('<div class="gs">Iteration 13</div>');  
                if (i == 14)
                    $('#graph15').append('<div class="gs">Final clusters</div>');  
